...
import com.spaceobj.websoket.constant.WebSocketProperties;
import com.spaceobj.websoket.handler.ChatHandler;
...
public class WSServerInitialzer extends ChannelInitializer<SocketChannel> {
    ...
    protected void initChannel(SocketChannel ch) throws Exception {
        ...
        // 空闲检测
        pipeline.addLast(new ReadTimeoutHandler(WebSocketProperties.READ_TIMEOUT_SECONDS, TimeUnit.SECONDS));
         ...
         */
        pipeline.addLast(new HttpObjectAggregator(WebSocketProperties.MAX_CONTENT_LENGTH));
         ...
         */
        pipeline.addLast(new WebSocketServerProtocolHandler(WebSocketProperties.PATH, null, true, WebSocketProperties.MAX_FRAME_SIZE));
