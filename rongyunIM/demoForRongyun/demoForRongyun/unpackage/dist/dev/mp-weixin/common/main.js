...
/* 0 */
/*!*********************************************************************************!*\
  !*** /Users/zhr/study/practice/rongyunIM/demoForRongyun/demoForRongyun/main.js ***!
  \*********************************************************************************/
...
/* 6 */
/*!*********************************************************************************!*\
  !*** /Users/zhr/study/practice/rongyunIM/demoForRongyun/demoForRongyun/App.vue ***!
  \*********************************************************************************/
/*! no static exports found */
...
/* 7 */
/*!**********************************************************************************************************!*\
  !*** /Users/zhr/study/practice/rongyunIM/demoForRongyun/demoForRongyun/App.vue?vue&type=script&lang=js& ***!
  \**********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var _default = {
  ...
  created: function created() {
    this.createWatch();
    var token = uni.getStorageSync('IMToken');
    if (token != "" && token != null) {
      this.connect(token);
    } else {
      this.getMeId();
  ...
  methods: {
    getMeId: function getMeId() {var _this = this;
      ...
      then(function (res) {
        ...
        _this.createConnect(datas.token);
        uni.setStorageSync('meInfo', meInfo);
      });
    },
    createConnect: function createConnect(ry_token) {
      uni.setStorageSync('IMToken', ry_token);
      this.connect(ry_token);
      uni.hideLoading();
    },
    connect: function connect(imtoken) {var _this2 = this; // 建立 IM 连接
      this.$im.connect({ token: imtoken }).then(function (user) {
    ...
    userListFn: function userListFn() {
      console.log("app.vue");
      var that = this;

      this.$im.Conversation.getList().then(function (conversationList) {
        console.log('获取会话列表成功', conversationList);
        var meId = uni.getStorageSync("meInfo").id;
        conversationList = conversationList.filter(function (item) {return item.latestMessage.content.content.msg.sideinfo.uid == meId || item.latestMessage.content.content.msg.userinfo.uid == meId;});
    ...
    createWatch: function createWatch() {// 添加事件监听
      var that = this;
      console.log("添加事件监听");
      // 获取会话列表
      ...
      this.$im.watch({
        ...
        // 监听聊天室 KV 数据变更
        chatroom: function chatroom(event) {
          /**
                                             * 聊天室 KV 存储数据更新
                                             * @example
                                             * [
...
/* 9 */
/*!*******************************************************************************************************************!*\
  !*** /Users/zhr/study/practice/rongyunIM/demoForRongyun/demoForRongyun/App.vue?vue&type=style&index=0&lang=scss& ***!
  \*******************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
